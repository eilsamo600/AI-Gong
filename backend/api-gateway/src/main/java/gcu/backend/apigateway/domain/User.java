...
public class User {
     ...
     * This method is used to authorize the user as an admin
     * 
     * @param none
     * 
     * @return none
     ...
     * This method is used to set the refresh token of the user
     * 
     ...
     * This method is used to update the refresh token of the user
     * 
     * @param String updateRefreshToken, the refresh token of the user
     * 
     * @return none
     */
