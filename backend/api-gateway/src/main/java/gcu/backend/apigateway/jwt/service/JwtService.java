package gcu.backend.apigateway.jwt.service;
...
public class JwtService {
    ...
    // Field 'userRepository', type 'UserRepository'
     ...
     */
    public void sendAccessAndRefreshToken(ServerHttpResponse response, String accessToken, String refreshToken) {
        response.setStatusCode(HttpStatus.OK);
     ...
     * AccessToken 헤더 설정
     */
    public void setAccessTokenHeader(ServerHttpResponse response, String accessToken) {
        response.getHeaders().add(accessHeader, accessToken);
    }

    /**
     * RefreshToken 헤더 설정
     */
    public void setRefreshTokenHeader(ServerHttpResponse response, String refreshToken) {
        response.getHeaders().add(refreshHeader, refreshToken);
    }
