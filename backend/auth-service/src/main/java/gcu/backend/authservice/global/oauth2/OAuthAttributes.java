package gcu.backend.authservice.global.oauth2;
...
import gcu.backend.authservice.global.oauth2.userinfo.GoogleOAuth2UserInfo;
import gcu.backend.authservice.global.oauth2.userinfo.OAuth2UserInfo;
